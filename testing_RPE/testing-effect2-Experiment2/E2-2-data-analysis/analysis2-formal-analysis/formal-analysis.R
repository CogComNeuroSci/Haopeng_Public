...
setwd('C:/Users/haopchen/OneDrive - UGent/Desktop/工作/phd-work/phd2-research/research1-nature-of-testing-effect/testing-effect4-Experiment2/E2-3-data-analysis/second-time/analysis2-formal-analysis')
...
### load the data
data <- read.csv('data_all_delete_lower_than_34.csv')
...
## delete the correct items in test 1
