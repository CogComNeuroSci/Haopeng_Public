# -*- coding: utf-8 -*-
"""
Created on Tue Feb 14 10:58:49 2023
...
data_all.loc[:,'reward2'].replace([True, False], [4, 0], inplace=True)
data_all.loc[:,'reward3'].replace([True, False], [4, 0], inplace=True)
data_all.loc[:,'reward4'].replace([True, False], [4, 0], inplace=True)
data_all.loc[:,'reward5'].replace([True, False], [4, 0], inplace=True)
...
data_all.loc[:, ['confidence2', 'confidence3', 'confidence4', 'confidence5']] = data_all.loc[:, ['confidence2', 'confidence3', 'confidence4', 'confidence5']] - 1 

data_all['confidence'] = data_all['confidence3']

# set the confidence in studying as 4
data_all.loc[data_all['learning_method3']==1,'confidence'] = 4 
...
# '5cd8638310887400162dafec', '5ce6525a185715001708c627', '5d63f9cd26a2ac001758c70d', 
# '5e19961e1b8014222555c3b2', '5e2761b3ce16da9982f88406', '5ec7d68512268325623eb178', 
# '5f0f44ccf585170d7b14c030', '5f647d84fc17022190cfac83', '5f8d77f0b348950659f1919e', 
# '606ddb0033f69d1a832059cd', '615f4e20d504f648ffd22972', '6277f267a2d1f33351549d0d', 
# '62aa2bdbe3bab086b19ea5ab', '62b1ff970dfb7055f35d6937', '62c5e88d434d3ad81799df4d', 
# '62fb8535d6e34ce6214ba696', '63ced2a1d7f0270214c80274']
...
### save the data
data_all.to_csv('data_all_delete_lower_than_34.csv')
...
### plot
data_plot_srpe = data_all.groupby(by=['participant', 'srpe', 'learning_method', 'reward'])['accuracy'].mean()
data_plot_srpe = data_plot_srpe.reset_index()
data_plot_srpe.columns = ['participants', 'SRPE', 'Testing Vs Studying', 'Reward', 'Accuracy']
