...
if all_data:
    ...
    ax = sns.regplot(data=data_plot, x='PE', y='accuracy', x_estimator=np.mean, order=8)
else:
...
ax.set_xlabel('Prediction error', fontsize=25)
ax.set_ylabel('Human accuracy', fontsize=25)
ax.set_xlim(-1.1, 1.1, 0.5)
ax.set_ylim(0, 1.1)
