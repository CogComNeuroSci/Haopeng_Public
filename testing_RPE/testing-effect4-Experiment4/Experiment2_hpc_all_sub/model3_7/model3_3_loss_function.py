...
def log_like(parameters, W0, X_phase2, Y_conf_phase2,
    ...
    parameters[2:4] = 10*logistic(parameters[2:4])
    #print(parameters)
    ...
    ### formal learning
    W3 = model_learning(b=parameters[1], slope=parameters[2], bias=parameters[3], W=W2.copy(), X=X_phase3.copy(), Y_feed=Y_feed_phase3.copy(), Y_options=Y_options_phase3.copy(), TvS=TvS_phase3.copy(), Reward3=Reward3_phase3.copy(), swa_words=swa_words.copy())
    
    
    ### model testing
    Y_pred, Choices = model_testing(slope=parameters[2], bias=parameters[3], W=W3.copy(), X=X_testing.copy(), Y_options=Y_options_testing.copy(), swa_words=swa_words.copy())
