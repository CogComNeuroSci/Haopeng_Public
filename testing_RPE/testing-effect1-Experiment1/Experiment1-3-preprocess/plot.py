...
data_all_plot = data_all_plot.reset_index()
data_all_plot.columns = ['Pars', 'Feedback', 'Testing Vs Studying', 'Human accuracy']
...
#data_all = data_all.loc[data_all['input_word2']==data_all['input_word3'], :]
...
fig, ax = plt.subplots()
ax = sns.heatmap(data, cmap='Reds', vmin=0.4, vmax=0.6)
ax.invert_yaxis()
fig.subplots_adjust()
