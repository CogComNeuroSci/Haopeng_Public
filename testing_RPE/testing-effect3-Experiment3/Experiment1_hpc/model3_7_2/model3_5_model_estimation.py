...
for b in range(9):
    ...
    for sub in range(X_phase2_3d.shape[0]):
        ...
        # formal learning
        W3 = model_learning(b=parameters[1], slope=parameters[2], bias=b, W=W2.copy(), X=X_phase3, Y_feed=Y_feed_phase3, Y_options=Y_options_phase3, TvS=TvS_phase3, Reward3=Reward3_phase3, swa_words=swa_words)
        
        # model testing
        Y_pred, Choices = model_testing(slope=parameters[2], bias=b, W=W3.copy(), X=X_testing, Y_options=Y_options_testing, swa_words=swa_words)
    ...
    fig.savefig('figs/model_performance_b{}.tif'.format(b), dpi=300)