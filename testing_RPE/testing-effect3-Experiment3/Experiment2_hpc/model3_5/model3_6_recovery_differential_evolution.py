...
B = 1 -A
Slope = 10*np.random.rand(100)
Bias = 10*np.random.rand(100)
...
#for g in [0, 1, 2]:
    ...
    for opt in range(10):
        ...
        res = differential_evolution(log_like,
                                     x0=x0,
                                     bounds=bounds,
    ...
    if not os.path.exists('data/E1_data_recovery_differential_evolution/'):
        os.makedirs('data/E1_data_recovery_differential_evolution/')
    
    data_all.to_csv('data/E1_data_recovery_differential_evolution/parameters_recovery.csv')
