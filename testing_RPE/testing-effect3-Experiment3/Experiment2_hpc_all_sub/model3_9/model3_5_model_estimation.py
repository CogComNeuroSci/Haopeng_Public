...
data_all.loc[data_all['TvS']==1, 'Model_accuracy'].mean() - data_all.loc[data_all['TvS']==0, 'Model_accuracy'].mean()
data_all.loc[data_all['TvS']==1, 'Human_accuracy'].mean() - data_all.loc[data_all['TvS']==0, 'Human_accuracy'].mean()
