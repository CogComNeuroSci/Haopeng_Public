...
#for g in [0, 1, 2]:
    ...
    if not os.path.exists('data/E1_data_recovery_powell/'):
        os.makedirs('data/E1_data_recovery_powell/')
    
    data_all.to_csv('data/E1_data_recovery_powell/parameters_recovery.csv')
