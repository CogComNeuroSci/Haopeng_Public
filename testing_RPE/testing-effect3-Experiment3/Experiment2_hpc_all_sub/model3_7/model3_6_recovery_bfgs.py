...
#for g in [0, 1, 2]:
    ...
    if not os.path.exists('data/E1_data_recovery_bfgs/'):
        os.makedirs('data/E1_data_recovery_bfgs/')
    
    data_all.to_csv('data/E1_data_recovery_bfgs/parameters_recovery.csv')
